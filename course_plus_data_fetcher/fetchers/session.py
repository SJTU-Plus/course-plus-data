...
class FetchSession:
    def __init__(self, username: str, password: str):
        ...
        self._fetch_session = AsyncClient(cookies=self._account_session.cookies, headers=HEADERS)

    async def get(self, url: str, params: dict = None, timeout: int = 5, **kwarg):
        return await self._fetch_session.post(url, params=params, timeout=timeout, **kwarg)
